...
# ------------------------------------------------------------
# Update project Cloudinary references
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Update blog Cloudinary references
# ------------------------------------------------------------
...
education_data = [
    {
        ...
        "field_of_study": "",
        "description": (
            "Completed Grade 1 through Grade 8, establishing "
    ...
    },
    {
        ...
        "field_of_study": "",
        "description": (
            "Completed secondary education from Grade 9 through "
            "Grade 12, preparing for higher education."
        ),
    ...
    },
    {
        ...
        "description": (
            ...
            "with a foundation in software engineering, web development, "
            "databases, networking, algorithms, and computer systems."
        ),
...
experience_data = [
    {
        ...
        "description": (
            ...
            "network administration, infrastructure, troubleshooting, "
            "IT support, and data center operations."
        ),
    ...
    },
    {
        ...
        "description": (
            "Designed and developed an AI-based web platform for "
            "online learning and remote education. The system supports "
            "course management, assignment submission, virtual learning, "
            "and an AI assistant to support students and instructors."
        ),
        "location": "University of Gondar",
    ...
    },
    {
        ...
        "description": (
            "Building a modern Ethiopian online marketplace that connects "
            "customers and local businesses through digital commerce. "
            "The platform focuses on local products, modern shopping "
            "experiences, product discovery, and scalable full-stack "
            "architecture."
        ),
        "location": "Ethiopia",
